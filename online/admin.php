					...
					<div class="row">
						<div class="col-lg-8">
							<div class="main-frame text-center">
								<h1 style="font-size:400%;"><strong style="color: #337ab7">ADMIN</strong></h1>
								...
								<div class="tab-content">
									<div class="tab-pane in fade active">
										<form action="" name="login" onsubmit="return validate();"method="post" style="padding-left:20px; padding-right:20px"><br><br>
											...
											<div class="form-group"><input class="form-control" type="submit" name="signin" value="Sign In" style="background-color: #337ab7"></div>
										</form>
									</div>
								</div>
